import { _ as pe } from "./preload-helper.C1FmrZbK.js";
const me = Symbol(),
  ...
  z = { BASE_URL: "./", DEV: !1, MODE: "production", PROD: !0, SSR: !1 },
    ...
    c = (o, g, I = n) => {
      ...
      return (
        ...
        Reflect.ownKeys(o).forEach((j) => {
          if (Object.getOwnPropertyDescriptor(w, j)) return;
          const O = Reflect.get(o, j),
            A = { value: O, enumerable: !0, configurable: !0 };
          if (x.has(O)) te(O, !1);
          else if (O instanceof Promise) delete A.value, (A.get = () => I(O));
          else if (C.has(O)) {
            const [y, H] = C.get(O);
            A.value = c(y, H(), I);
          }
        ...
        R = t(q, {
          ...
          set(i, a, r, h) {
            ...
            if (r instanceof Promise)
              r.then((L) => {
                (r.status = "fulfilled"), (r.value = L), w(["resolve", [a], L]);
              }).catch((L) => {
                (r.status = "rejected"), (r.reason = L), w(["reject", [a], L]);
              });
            else {
              !C.has(r) && s(r) && (V = W(r));
...
const u = P({
  ...
  Ie = {
    state: p,
    subscribe(e) {
      return D(p.events, () => e(we(p.events[p.events.length - 1])));
    },
    initialize() {
      p.enabled &&
...
var Le = Object.defineProperty,
  ...
  Ae = (e, t) => {
    ...
    if (oe) for (var s of oe(t)) Pe.call(t, s) && re(e, s, t[s]);
    return e;
  };
const ae = m.isMobile(),
  E = P({
...
var Me = Object.defineProperty,
  ...
  le = (e, t, s) =>
    t in e
      ...
      : (e[t] = s),
  je = (e, t) => {
    for (var s in t || (t = {})) Se.call(t, s) && le(e, s, t[s]);
...
const N = P({ themeMode: Ue() ? "dark" : "light" }),
  ce = {
    state: N,
    subscribe(e) {
      return D(N, () => e(N));
...
class Te {
  ...
  async initUi() {
    if (typeof window < "u") {
      await pe(() => import("./index.BqGd3dWV.js"), [], import.meta.url);
...
const Ve = Object.freeze(
  Object.defineProperty(
    { __proto__: null, WalletConnectModal: Te },
    Symbol.toStringTag,
    { value: "Module" }
  )
);
